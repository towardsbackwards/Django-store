    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(default=18, null=True, verbose_name='Возраст')),
                ('activation_key', models.CharField(blank=True, max_length=128)),
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2019, 8, 29, 20, 49, 29, 183767, tzinfo=utc))),
