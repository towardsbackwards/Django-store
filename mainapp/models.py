...
class Product(models.Model):
    ...
    # Если понадобится - усложним 1 или 3й. Варианты при удалении:  CASCADE, SET_NULL, PROTECT
    # Для автозаполнения третьим аргументов в ForeignKey было null = True. после автозаполнения удалили и заново мигрировали модель
    # 3. Многое к многому = в одной категори много товаров, но и один товар может быть в нескольких категориях
...
class ContactCard(models.Model):
    ...
    phone = models.CharField(max_length=255, verbose_name='Номер телефона', default='Номер не указан') #charfield для того, чтобы указывать номер с дефисами
